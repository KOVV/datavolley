...
<form class="form-horizontal" id="getPersonsByBirthdate"> 
<?php echo csrf_field(); ?>
  <div class="form-group">
    <label for="inputDescription">Leeftijd</label>
    <input type="text" class="form-control" id="inputDescription" placeholder="2004;2005;2006">
  </div>
<div>
  <p id="getPersonsByBirthdateRespons">Testje</p>
</div>
