...
<head>
  ...
  <!-- HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
    ...
    <body style="height:inherit; padding:0px;">
      ...
      <div hidden class="row" id="rowWithoutToken" style="text-align:center;    font-family: 'Roboto', sans-serif;">
    ...
    <div hidden class="row" id="rowWithToken">
      ...
      <h3 id="headerIntro" style="padding-left:50px; padding-right:50px;text-align:center;"> 
        Welkom <span id="headerName"> mathias</span>, laat hieronder weten of je aanwezig zal zijn op de detectietraining. Controleer nadien je gegevens en vul aan waar nodig.</h3>
       ...
       <form id="radioActiviteit" class="form-horizontal">
         <div class="radio">
          <label>
            ...
            Ik zal aanwezig zijn op de provinciale detectietraining van 3 september
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" name="activiteitKeuze" id="ntAanwezigIntersse" value="2">
            Ik kan helaas niet aanwezig zijn op 3 september maar heb wel interesse in de provinciale selectiewerking               </label>
          </div>
          <div class="radio ">
            <label>
      ...
      <div hidden id="gegevens" class="col-xs-12" >
        ...
        <p>Onderstaande gegevens bekomen we via de Vlaamse Volleybalbond en werden door jouw club ingegeven bij aanvraag van jouw lidkaart. Pas aan en vervolledig waar nodig!</p>
        ...
        <div class="form-group" id="groupTel">
          ...
          <div class="col-sm-6">
            <input type="text" class="form-control" id="inputTelefoonNr"  placeholder="Telefoon nummer">
            <div hidden class="parent-help-block">
              <span  class="help-block">
              </span>
            </div>
    ...
    <div hidden class="col-xs-12" id="verstuurBtnDiv" style="text-align:center;">
     <button type="btn" id="verstuurBtn" class="btn btn-primary" style="margin-bottom:30px;">Versturen</button>
...
$('#topAlert').text("Token niet teruggevonden. Probeer opnieuw of neem contact op met kovv-pjc-voorzitter@volleybalkovv.be");
$('#topAlert').show();
} else {
...
window.location = "registreer/success?actStatus="+activiteitStatus; 
...
$('#topAlert').text("Fout bij het versturen. Probeer opnieuw of neem contact op met kovv-pjc-voorzitter@volleybalkovv.be");
$('#topAlert').show();
